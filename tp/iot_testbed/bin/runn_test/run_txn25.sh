...
do
    for (( c=1; c<=$txn_count; c++ ))
        do
            ...
            python3 /home/manhattan/Documents/research-paper/iot_testbed/bin/iot_tp.py send "$image" --path /home/manhattan/Documents/research-paper/images/ --url http://10.0.0.25:1002
            let "send_count+=1"
