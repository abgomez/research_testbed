...
txn_count=10
txn_counter=1
node="http://10.0.0.21:1002"
result_path="/home/manhattan/Desktop/research_testbed/sawtooth1.1/poet/scalability/results/1-min/10-nodes/one-link/10txn/parallel"
